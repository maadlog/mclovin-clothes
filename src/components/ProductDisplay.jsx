...
export function ProductDisplayWithStock({ product, stock, onChange }) {
...
export function ProductDisplay({ product, onClick }) {
	const [imgUrl, setImage] = useState('favicon.ico')
	useEffect(() => {
		new ProductsRepository()
			.getPictureUrl(product.id)
	...
	return <li className='product-display' onClick={onClick}>
